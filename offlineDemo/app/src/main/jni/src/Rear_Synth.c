...
*/
        ...
        //FILE *fp_mgc = fopen("/sdcard/mid.mgc", "wb");
        //FILE *fp_lf0 = fopen("/sdcard/mid.lf0", "wb");
        //FILE *fp_bap = fopen("/sdcard/mid.bap", "wb");
        //FILE *fp_mgc = fopen("/sdcard/mid.mgc", "rb");
        //FILE *fp_lf0 = fopen("/sdcard/mid.lf0", "rb");
        //FILE *fp_bap = fopen("/sdcard/mid.bap", "rb");

        //starttime = 0+num_skip;
        //endtime = num_frame-num_skip;
        ...
        for (int q = 0; q < num_frame; q++)
        {
            ...
            //fread(world_input_param[q], sizeof(float), num_spectrum, fp_mgc);
            //fread(world_input_param[q]+num_spectrum, sizeof(float), 1, fp_lf0);
            //fread(world_input_param[q]+num_spectrum+1, sizeof(float), 1, fp_bap);
        }
